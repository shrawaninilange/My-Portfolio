			...
			>
				...
				>
					...
					<div className={styles.btn}>
						<a
							href='https://drive.google.com/file/d/1OVX0kalNdqFltv3ZLvRQryMCgI3LErDD/view?usp=sharing' // Resume
							target='blank'
						>
							<Button
								text={
				...
				>
					<img
					 height="400px"
						src='https://i.ibb.co/6vHCr6V/Whats-App-Image-2022-08-19-at-12-00-19-PM.jpg' //my Picture
						alt='Profile pic'
					/>
